...
public abstract class AbstractReplaceExplicitTypeWithVariableIntentionAction extends AbstractValVarIntentionAction {
    ...
    public LocalizeValue getText() {
        return LombokLocalize.replaceExplicitTypeWith0Lombok(StringUtil.getShortName(variableClassName));
    }
    ...
    protected abstract boolean isAvailableOnDeclarationCustom(
        @Nonnull PsiDeclarationStatement context,
    ...
    public void invokeOnVariable(PsiVariable psiVariable) {
        ...
        PsiJavaCodeReferenceElement referenceElementByFQClassName =
            elementFactory.createReferenceElementByFQClassName(variableClassName, psiVariable.getResolveScope());
