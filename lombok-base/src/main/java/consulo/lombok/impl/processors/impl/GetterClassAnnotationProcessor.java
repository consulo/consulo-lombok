 ...
 */
@ExtensionImpl
public class GetterClassAnnotationProcessor extends LombokSelfClassProcessor
{
	@Inject
	public GetterClassAnnotationProcessor()
	{
		super(GetterFieldAnnotationProcessor.ANNOTATION_CLASS);
	}
	...
	public void processElement(@Nonnull PsiClass parent, @Nonnull PsiClass psiClass, @Nonnull List<PsiElement> result)
	{
		...
		for(PsiField ownField : ownFields)
		{
			...
			result.add(GetterFieldAnnotationProcessor.createGetter(parent, ownField, annotation));
		}
	}
